...
<head>
  ...
  <title>Si Budak Corporate - Home</title>
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="hero-banner__img">
              <img class="img-fluid" src="img/Desain.png" alt="">
            </div>
          </div>
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              <h1>Website Absensi Corporate</h1>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam obcaecati quos tempore veniam nesciunt sit, unde quidem cumque voluptatibus repudiandae at porro magnam, accusamus doloribus explicabo vel ratione ipsam beatae.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <h3 class="card-feature__title" ><img class="img-log" src="img/facebook.png">facebook</h3>
                <p class="card-feature__subtitle">Mark Zuckerberg </p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <h3 class="card-feature__title" ><img class="img-log" src="img/whatsapp.png">Whatsapp</h3>
                <p class="card-feature__subtitle">Plus 62</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <h3 class="card-feature__title" ><img class="img-log" src="img/youtubee.png">Youtube</h3>
                <p class="card-feature__subtitle">Agak Laen</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <footer class="footer-area section-gap">
		<div class="container">
			...
			<div class="footer-bottom row align-items-center text-center text-lg-left">
				<p class="footer-text m-0 col-lg-8 col-md-12"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --> &copy;<script>document.write(new Date().getFullYear());</script> Si Budak Corporate  <i class="fa fa-heart" aria-hidden="true"></i>  <a href="https://colorlib.com" target="_blank"></a>
